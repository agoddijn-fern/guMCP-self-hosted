...
from ...utils.dropbox.util import authenticate_and_save_credentials, get_credentials
...
async def get_credentials(user_id: str, service_name: str, api_key: str = None) -> str:
    ...
    """
    from ...utils.dropbox.util import get_credentials as get_dropbox_credentials
