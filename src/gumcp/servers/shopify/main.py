...
sys.path.insert(0, os.path.join(project_root, "src", "gumcp"))
...
from ...utils.shopify.util import get_credentials, get_service_config
from ...utils.shopify.graphql_schemas import (
...
def authenticate_and_save_credentials(user_id, scopes=None):
    ...
    from ...utils.shopify.util import authenticate_and_save_credentials as auth_save
